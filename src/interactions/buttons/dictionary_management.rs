            ...
            CreateInteractionResponse::Modal(
                CreateModal::new("TTS_CONFIG_SERVER_ADD_DICTIONARY", "辞書追加").components(vec![
                    CreateModalComponent::Label(CreateLabel::input_text(
                        "辞書名",
                        CreateInputText::new(InputTextStyle::Short, "rule_name").required(true),
                    )),
                    CreateModalComponent::Label(CreateLabel::input_text(
                        "変換元（正規表現）",
                        CreateInputText::new(InputTextStyle::Paragraph, "from").required(true),
                    )),
                    CreateModalComponent::Label(CreateLabel::input_text(
                        "変換先",
                        CreateInputText::new(InputTextStyle::Short, "to").required(true),
                    )),
                ]),
            ),
        )
